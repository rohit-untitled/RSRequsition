...
module.exports = {
  requisitionAPI: async function (instanceName, userName, requestToken, fusionEnv, categoryId, categoryName, selectedItem, selectedItemDesc, quantity, selectedItemPrice, justification, conversation, done) {
    ...
    conversation.logger().info("Quantity ", quantity);
    var now = new Date();
