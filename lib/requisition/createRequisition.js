...
//     conversation.logger().info('Fusion Type: ', payload.fusionType);
//     conversation.logger().info('BUPayloadHolder: ', JSON.stringify(BUPayloadHolder));
//     conversation.logger().info('requisitionPayloadHolder: ', JSON.stringify(requisitionPayloadHolder));
...
//     // headerValues.ItemDescription = payload.selectedItemDesc;
