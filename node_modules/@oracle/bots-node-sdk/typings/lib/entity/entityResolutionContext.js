...
exports.EntityResolutionContext = void 0;
 ...
 * @memberof module:Lib
 */
class EntityResolutionContext extends baseContext_1.BaseContext {
    /**
    ...
    */
    ...
    _initSystemEntityDisplayProperties() {
        this._systemEntityDisplayProperties = {
            ...
            'DATE_TIME.DATETIME': { 'properties': ['date', 'time'], 'function': ((date, time) => (date ?
                    (new Date(date.value).toDateString() + ' ') : '') + (time ? time.value.substring(0, 5) : '')) },
            'DATE_TIME.INTERVAL': { 'properties': ['startDate', 'startTime', 'endDate', 'endTime'], 'function': ((startDate, startTime, endDate, endTime) => (startDate ? new Date(startDate.value).toDateString() + ' ' : '')
...
exports.EntityResolutionContext = EntityResolutionContext;
