...
exports.CustomComponentContext = void 0;
 ...
 */
class CustomComponentContext extends baseContext_1.BaseContext {
    /**
    ...
    */
    ...
    reply(payload, channelConversation) {
        ...
        if (messagePayload) {
            ...
            const rawMessagePayload = messageModel_1.MessageModel.rawConversationMessage(payload);
            const messageModel = new messageModel_1.MessageModel(rawMessagePayload);
...
exports.CustomComponentContext = CustomComponentContext;
