...
class ComponentRegistry {
    ...
    getComponentMethods(component) {
        ...
        return properties.filter(k => definitions_1.isType(component[k]) && omit.indexOf(k) === -1);
    }
}
...
function isComponent(ref) {
    return (definitions_1.isType(ref) && ref.prototype && (definitions_1.isType(ref.prototype.invoke) || definitions_1.isType(ref.prototype.handlers) ||
        (typeof ref.prototype.handlers === 'object'))) ||
        (typeof ref === 'object' && (definitions_1.isType(ref.metadata) || typeof ref.metadata === 'object') && (definitions_1.isType(ref.invoke) ||
            definitions_1.isType(ref.handlers) || (typeof ref.handlers === 'object')));
}
